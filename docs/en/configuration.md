...
1. Navigate to the **Application** or **Storage** tab.
1. In the left sidebar under **Cookies**, select the address `https://module.gm.th-koeln.de`.
1. Look for the cookie named `access_token` in the list.
1. Copy the value of this cookie and enter it as `MOCOGI_API_TOKEN` in your configuration.
