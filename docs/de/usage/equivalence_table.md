...
3.  Pflichtmodule, die nicht in der Liste stehen, aber in den POs vorhanden sind, ergänzt.  
4.  Das Ergebnis primär nach dem empfohlenen Semester der neuen PO sortiert in einer formatierten Word-Tabelle ausgibt.  
...
4.  **Sortierung**: Die Tabelle wird primär nach dem empfohlenen Semester der **neuen** PO sortiert. Falls ein Modul nur in der alten PO existiert, wird dessen Semester verwendet. Sekundär erfolgt die Sortierung alphabetisch nach dem Titel des Moduls in der neuen PO.  
